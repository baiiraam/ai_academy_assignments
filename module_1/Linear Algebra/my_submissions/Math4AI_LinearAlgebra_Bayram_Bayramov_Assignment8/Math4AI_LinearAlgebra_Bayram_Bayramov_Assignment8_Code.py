...
# Reconstruct
Sigma_mat_diag = np.diag(S_scratch) # Correctly create Sigma as (rank, rank) diagonal matrix
...
print(f"Is reconstruction accurate? {np.allclose(test_matrix, reconstructed, atol=1e-8)}")